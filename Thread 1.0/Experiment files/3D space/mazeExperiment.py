...
def main():
	...
	while True:
		...
		#top
		if (abs(x-1000) < 500 and abs(y-1000) < 600 and abs(z-2000) < 500):
		...
		#left
		if (abs(x-2000) < 500 and abs(y-1000) < 600 and abs(z-1000) < 500):
			canvas.set_fill_color(0, 0, 1)
		...
		#back
		if (abs(x-1000) < 500 and abs(y-2000) < 600 and abs(z-1000) < 500):
			canvas.set_fill_color(0, 0, 1)
