...
class MyScene (Scene):
    ...
    def draw(self):
        ...
        fill(0.95,0.6,0.6)
        tint(1,1,1,1)
        ellipse(self.cx2-0.0-self.R,self.cy2-self.R-130,self.R*2,self.R*2)
        text('SOS', font_name='Verdana', font_size=12.0, x=self.cx2, y=self.cy2+self.R-167, alignment=5)
        ...
        if self.measuringOn == True:
            ...
            text('Tap to return to start', font_name='Verdana', font_size=16.0, x=self.cx2, y=self.cy2+self.R+120, alignment=5)
    ...
    def touch_began(self, touch):
        ...
        elif x > (self.size.w-30) and y < 30:
