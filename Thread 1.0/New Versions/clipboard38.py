    ...
    def draw(self):
        ...
        #The return back..
            ...
            if (len(self.locationsLeft) > 3):
                ...
                stroke_weight(2)
                line(self.centerX2-trueDegreeCos*self.radius,self.centerY2-trueDegreeSin*self.radius+50,self.centerX2+trueDegreeCos*self.radius,self.centerY2+trueDegreeSin*self.radius+50)
                stroke(1,0.3,0.3)
                line(self.centerX2+trueDegreeCos*self.radius,self.centerY2+trueDegreeSin*self.radius+50, self.centerX2,self.centerY2+self.radius+12.5)
